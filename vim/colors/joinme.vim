...
if has('gui_running') || &t_Co == 88 || &t_Co == 256
  ...
  if &background ==# 'dark'
    ...
    let s:hue_1  = 'ffffff' " cyan
    let s:hue_2  = '258095' " blue
    let s:hue_3  = 'f19336' " join.me orange
    let s:hue_4  = '8adc44' " join.me lime
    ...
    let s:syntax_bg     = '2d2d2d'
    let s:syntax_gutter = 'eeeeee'
    let s:syntax_cursor = '3c424c'

    let s:syntax_accent = '258095'

    let s:vertsplit    = 'eeeeee'
    let s:special_grey = '111111'
    ...
    let s:hue_1  = 'd19a66' " orange 1
    let s:hue_1  = 'e5c07b' " orange 2
